(function() {
	try {
		...
		var version = '0.2.3'; // The required API version
		var auth    = {};
		...
		var defaultOptions = [
			...
			},
			{
				'name'       : 'threads',
				'type'       : 'number',
				'description': 'Number of parallel AWS threads (default: 1)'
			}
		];
		var shortHands = {
			'c': ['--config'],
